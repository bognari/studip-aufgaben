...
<?= $this->render_partial('index/_breadcrumb', array('path' => array('overview', array('student/view_student/' . $task->getId(), $task['title']), array('index/analytics_reload/' . $handin_id, _('Warte auf Analyseergebnisse'))))) ?>
