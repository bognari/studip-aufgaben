 ...
 * @category    Stud.IP
 */
class Leeroy_SimpleCollection extends StudipArrayObject
{
    ...
    {
        return new Leeroy_SimpleCollection($data);
    }
    ...
    public static function getCompFunc($operator, $args)
    {
        if ($operator instanceOf Closure) {
            ...
            switch ($operator) {
                ...
                case '%=':
                    $comp_func = function ($a) use ($args) {
                        $a = strtolower(Leeroy_SimpleCollection::translitLatin1($a));
                        $args = array_map('Leeroy_SimpleCollection::translitLatin1', $args);
    ...
    public static function translitLatin1($text)
    {
        ...
        $text = str_replace(array('�', 'A', '�', '�', '�', '�', '�'), array('a', 'A', 'o', 'O', 'u', 'U', 's'), $text);
    ...
    {
        return parent::exchangeArray(array_map('Leeroy_SimpleCollection::arrayToArrayObject', $input));
    }
    ...
    {
        return parent::append(Leeroy_SimpleCollection::arrayToArrayObject($newval));
    }
    ...
    function offsetSet($index, $newval)
    {
        ...
        return parent::offsetSet($index, Leeroy_SimpleCollection::arrayToArrayObject($newval));
    }
        ...
        $func = function ($d1, $d2) use ($sorter, $sort_func, $sort_locale) {
            do {
                ...
                if (!$sort_locale) {
                    ...
                    $value1 = Leeroy_SimpleCollection::translitLatin1(substr($d1[$field], 0, 100));
                    $value2 = Leeroy_SimpleCollection::translitLatin1(substr($d2[$field], 0, 100));
                }
